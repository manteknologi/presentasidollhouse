...
var griya = {
  ...
  init: function() { // Initialization
	...
	var pin1 = THREE.ImageUtils.loadTexture( 'textures/pin1.png' );
	var pin2 = THREE.ImageUtils.loadTexture( 'textures/pin2.png' );
	var pin3 = THREE.ImageUtils.loadTexture( 'textures/pin3.png' );

				var marker = new THREE.SpriteMaterial( { map: pin1 } );
				var sprite = new THREE.Sprite( marker );
				sprite.position.set( -45, -31, 42 );
				sprite.scale.set(20, 20, 20 );

				var marker = new THREE.SpriteMaterial( { map: pin2 } );
				var sprite1 = new THREE.Sprite( marker );
				sprite1.position.set( -10, -16, -7 );
				sprite1.scale.set(20, 20, 20 );

				var marker = new THREE.SpriteMaterial( { map: pin3 } );
				var sprite2 = new THREE.Sprite( marker );
				sprite2.position.set( 26, 4, -5 );
 ...
 */
 ...
 cekLight2=dLight;
	...
	var materials = [
					...
					loadTexture( 'textures/cube/white/px.png' ), // right
					loadTexture( 'textures/cube/white/nx.png' ), // left
					loadTexture( 'textures/cube/white/py.png' ), // top
					loadTexture( 'textures/cube/white/ny.png' ), // bottom
					loadTexture( 'textures/cube/white/pz.png' ), // back
					loadTexture( 'textures/cube/white/nz.png' )  // front
...
this.scene.add(new THREE.PointLightHelper(spotLight, 1));
  ...
  loadModel1: function() {
    ...
    oLoader.load('models/dollhouse.obj', 'models/dollhouse.mtl', function(object) {
OBJLoaded=object;
